...
7. Set %converter% argument, in both Initializer and PointAlloc, to the full path of GvasConverter.exe file from the corverter.zip that you downloaded. (Make sure that it's not surrounded by "")
